...
// ===== NasuaOS UI CORE =====
inline constexpr uint32_t COLOR_ZYTR_BG       = 0xFF008080; // klasyczny turkusowy desktop
inline constexpr uint32_t COLOR_ZYTR_DARK     = 0xFF808080; // cienie 3D
inline constexpr uint32_t COLOR_ZYTR_DARKER   = 0xFF404040;
inline constexpr uint32_t COLOR_ZYTR_LIGHT    = 0xFFE0E0E0; // highlight
inline constexpr uint32_t COLOR_ZYTR_HIGHLIGHT = 0xFFFFFFFF;
inline constexpr uint32_t COLOR_MOUSE = 0x00000000;

// ===== WINDOW ELEMENTS =====
inline constexpr uint32_t COLOR_TITLEBAR     = 0xFF000080; // klasyczny niebieski
inline constexpr uint32_t COLOR_TITLEBAR_INACTIVE = 0xFF808080;

inline constexpr uint32_t COLOR_ZYTRDOW       = 0xFFC0C0C0;
